...
$(addPhoneBtn).click(function (e) {
	...
	if (i < maxFields) {
		i++;
		container.append('<div class="form-group field-userphones-phone required"><div class="col-sm-offset-2 col-sm-5">' + input + '</div><div class="col-sm-1">' + removeBtn + '</div>' + errorDiv + '</div>');
	}
...
var length = formPhonesUpdate.find('div.form-group.field-userphones-phone').length; console.log(length);
