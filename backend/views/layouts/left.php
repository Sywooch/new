      ...
      Nav::widget(
          [
              ...
              'items'        => [
                  ...
                  [
                      'label' => '<span class="fa fa-user"></span> Старые пользователи',
                      'url'   => [ '/users-host/index' ]
                  ],
                  [ 'label' => '<span class="fa fa-user"></span> Старые объявления', 'url' => [ '/advert/index' ] ],
                  [ 'label' => '<span class="fa fa-user"></span> Новые объявления', 'url' => [ '/adverts/index' ] ],
                  [ 'label' => '<span class="fa fa-user"></span> Категории', 'url' => [ '/categories/index' ] ],
                  [ 'label' => '<span class="fa fa-user"></span> Подкатегории', 'url' => [ '/subcategories/index' ] ],
                  [ 'label' => '<span class="fa fa-user"></span> Города', 'url' => [ '/countries/index' ] ],
                  [ 'label' => '<span class="fa fa-user"></span> Тип объявления', 'url' => [ '/types/index' ] ],
                  [ 'label' => '<span class="fa fa-user"></span> Период', 'url' => [ '/periods/index' ] ],
                  [ 'label' => '<span class="fa fa-user"></span> Валюта', 'url' => [ '/currencies/index' ] ],
                  [
                      'label' => '<span class="fa fa-user"></span> Отклики',
                      'url'   => [ Yii::getAlias( '@frontend' ) . '/responses/index' ]
                  ],
                  [ 'label' => '<span class="fa fa-user"></span> Rbac', 'url' => [ '/user/admin' ] ],
              ],
          ]
      );
      ?>
